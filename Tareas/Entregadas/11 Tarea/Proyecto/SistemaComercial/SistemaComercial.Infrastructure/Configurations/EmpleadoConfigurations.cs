...
internal class EmpleadoConfigurations : IEntityTypeConfiguration<SistemaComercial.Dominio.Empleados.Empleado>
{
    public void Configure(EntityTypeBuilder<SistemaComercial.Dominio.Empleados.Empleado> builder)
    {
